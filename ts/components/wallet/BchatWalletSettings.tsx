...
import { updateDecimalValue, updateExeCurrency } from "../../state/ducks/walletConfig"
        ...
        <div className="wallet-settings-tabBox" >
            <Flex container={true} justifyContent='space-between' padding="10px 0" >
                ...
                <div onClick={() => dispatch(walletSettingMiniModal({
                    headerName: window.i18n("decimals"), content: decimal,
                    currency:decimalValue,
                    onClose: () => dispatch(walletSettingMiniModal(null)),
                    onClick: (e:any) => {dispatch(walletSettingMiniModal(null)),
            ...
            <Flex container={true} justifyContent='space-between' padding="10px 0">
                ...
                <div onClick={() => dispatch(walletSettingMiniModal({
                    headerName:window.i18n("displayCurrency"), content: currenyExt,
                    currency:exeCurrency,
                    onClose: () => dispatch(walletSettingMiniModal(null)),
                    onClick: (e:any) => {dispatch(updateExeCurrency(e)),dispatch(walletSettingMiniModal(null))}
