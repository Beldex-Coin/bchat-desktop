export type LocalizerKeys =
  ...
  | 'onionRoutingTitle'
  | 'onionRoutingDescriptionStable'
  | 'onionRoutingHopsTitle'
  | 'onionRoutingHopsZeroHop'
  ...
  | 'onionPathIndicatorDescriptionZero'
  | 'onionPathIndicatorDescriptionOneHop'
  ...
  | 'contactAvatarAlt'
  | 'failedToFetchScaledAvatarBlob'
  | 'gifTooLarge'
  | 'failedToScaleImage'
  | 'cannotScaleAttachmentDown'
  ...
  |'guidelinesDescription2'
  |'guidelinesDescription3'
  |'toKnowMore'
  |'marketingprop'
  |'forInvest..'
  |'guidelinesDescription4'
  |'guidelinesDescription5'
  ...
  |'paymentSentSuccessfully'
  |'paymentReceivedSuccessfully'
  |'selected'
  |'allowChatRequestQuestion'
  |'removeUsersTitle'
  ...
  |'sharedContactLabel'
  |'startChatNowTitle'
  |'startChatNowConfirmation'
  |'startChatting'
  |'checkInternetConnection'
  |'unknownGroup'
  |'legacyGroupNotSupportedCreate'
  |'legacyGroupNotSupportedRecreate'
  |'deleteGroupConfirmationWithName'
  |'yes'
  |'no'
  |'bchatUpdateTitle'
  |'bchatUpdateRestoreInstructions'
  |'copySeed'
  |'blockheightZeroTitle'
  |'blockheightZeroConfirmation'
  |'proceed'
  |'linkDeviceNoDisplayNameError'
  |'errorWithReason'
  |'themesTooltip'
  |'openToLatestMention'
  |'closeDebugLogAriaLabel'
  |'seedTooFewWords'
  |'seedMissingLastWord'
  |'seedInvalidWord'
  |'seedDecodeChecksumMismatch'
  |'seedChecksumWordInvalid'
  |'maxFileSizeLimit'
  |'deletionErrorGeneric'
  |'bchatFailedToStartTitle'
  |'bchatFailedToStartBody'
  |'unhandledError'
  |'unhandledPromiseRejection'
  |'quit'
  |'recoveryKeyViewKeyPublic'
  |'recoveryKeyViewKeyPrivate'
  |'recoveryKeySpendKeyPublic'
  |'recoveryKeySpendKeyPrivate'
  |'important'
  |'neverGiveKeyWarning'
  |'neverInputKeyWarning'
  |'confirmAccessKeyQuestion'
  |'yesIAmSure'
  |'noteLabel'
  |'warning'
  |'clear'
  |'callHistory'
  |'deleteSelectedMessagesTitle'
  |'sharedContactAndOther'
  |'sharedContactAndOthers'
