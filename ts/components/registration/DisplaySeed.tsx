...
export const Icons = (props: any) =>
    <div onClick={() => props.iconfunc()} className='paste-icon' data-tip="Paste" data-offset="{'top':30,'left':15}" data-place="right" style={{
        ...
        <>
            ...
            <div className='bchat-restore-seed-parent-box'>
                <div className='bchat-restore-seed-text-box'>
                    ...
                    <textarea className='bchat-restore-seed-text-area' name="text" onPaste={handlePaste} value={props.recoveryPhrase} placeholder="Enter your recovery seed to restore your account"
                        onChange={(e) => props.assignRecoveryPhase(e.target.value)}
                    ></textarea>

                </div>
                <div className='bchat-restore-seed-icon-box'  
                >{<Icons icon={"paste"} iconfunc={props.iconfunc} />}</div>
            </div>
        </>
